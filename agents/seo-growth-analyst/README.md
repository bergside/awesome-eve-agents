...
Find evidence-backed search opportunities and turn them into prioritized content and site recommendations.
...
slack, teams, eve, similarweb, local-falcon, webflow, notion

## Source files

- `instructions.md` defines the role, workflow, tool policy, and guardrails.
- `agent.ts` selects the model through Eve.
- `skills/seo-growth-analyst.md` contains the domain playbook.
