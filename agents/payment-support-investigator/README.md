# Payment Support Investigator

Investigate failed payments, refunds, settlements, and customer payment questions safely.
...
slack, teams, twilio, stripe, razorpay, notion

## Source files

- `instructions.md` defines the role, workflow, tool policy, and guardrails.
- `agent.ts` selects the model through Eve.
- `skills/payment-support-investigator.md` contains the domain playbook.
