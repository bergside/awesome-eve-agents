...
Prepare, review, publish, and verify content and media across modern website platforms.
...
slack, teams, eve, webflow, wix, cloudinary, bitly

## Source files

- `instructions.md` defines the role, workflow, tool policy, and guardrails.
- `agent.ts` selects the model through Eve.
- `skills/content-publishing-manager.md` contains the domain playbook.
