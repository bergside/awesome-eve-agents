...
Turn qualitative feedback and product signals into evidence-backed themes and opportunities.
...
slack, teams, eve, notion, linear, posthog, mixpanel

## Source files

- `instructions.md` defines the role, workflow, tool policy, and guardrails.
- `agent.ts` selects the model through Eve.
- `skills/product-feedback-synthesizer.md` contains the domain playbook.
