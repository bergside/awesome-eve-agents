...
Turn scattered bug reports and telemetry into prioritized, reproducible engineering work.
...
github, linear-agent, slack, sentry, linear, posthog

## Source files

- `instructions.md` defines the role, workflow, tool policy, and guardrails.
- `agent.ts` selects the model through Eve.
- `skills/bug-triage-coordinator.md` contains the domain playbook.
